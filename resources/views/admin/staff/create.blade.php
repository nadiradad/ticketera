    ...
    <div class="mx-auto max-w-lg space-y-6">
        <div>
            <a href="{{ route('admin.staff.index') }}" class="text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-400">←
                Personal</a>
            <h1 class="mt-3 text-2xl font-bold text-slate-900 dark:text-white">Nuevo usuario</h1>
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Solo técnicos y recepcionistas (los administradores se definen por base).</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="recepcionista" @selected(old('rol', 'recepcionista') === 'recepcionista')>
                            Recepcionista
                        </option>
                    </select>
                    @error('rol')
