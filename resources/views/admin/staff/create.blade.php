    ...
    <div class="mx-auto max-w-lg space-y-6">
        <div>
            <a href="{{ route('admin.staff.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">←
                Personal</a>
            <h1 class="mt-3 text-2xl font-bold text-slate-900">Nuevo usuario</h1>
            <p class="mt-1 text-sm text-slate-600">Solo técnicos y recepcionistas (los administradores se definen por base).</p>
        </div>
