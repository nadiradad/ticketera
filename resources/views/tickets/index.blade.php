...
@section('content')
    <div class="space-y-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Tickets</h1>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200 text-left text-sm">
                        <thead class="bg-slate-50">
                            <tr>
                                <th scope="col" class="px-5 py-3 font-semibold text-slate-700 sm:px-6">ID</th>
                                <th scope="col" class="px-3 py-3 font-semibold text-slate-700">Cliente</th>
                                <th scope="col" class="px-3 py-3 font-semibold text-slate-700">Estado</th>
